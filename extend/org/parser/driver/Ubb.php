...
class Ubb
{
    ...
    private $ubb = [
        ...
        ['images', '\[images(?:=([\d%]*)(?:,([\d%]*))?)?\]', '\[\/images\]', 'imgWidthAndHeight'],
        ['images', '\[images=(.*?)(?:,([\d%]*)(?:,([\d%]*))?)?\/\]', 'images'],
    ...
    {
        if (empty($data[2]) && empty($data[3])) {
            $data = "<images src=\"{$data[4]}\" />";
        } elseif (!empty($data[2]) && empty($data[3])) {
            $data = "<images width=\"{$data[2]}\" src=\"{$data[4]}\" />";
        } elseif (empty($data[2]) && !empty($data[3])) {
            $data = "<images height=\"{$data[3]}\" src=\"{$data[4]}\" />";
        } else {
            $data = "<images width=\"{$data[2]}\" height=\"{$data[3]}\" src=\"{$data[4]}\" />";
        }
        return $data;
    }
